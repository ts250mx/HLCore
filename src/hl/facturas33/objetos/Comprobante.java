...
public class Comprobante {
    ...
    public static class CfdiRelacionados {
        ...
        public static class CfdiRelacionado {
            ...
            @XmlAttribute(name = "UUID", namespace="http://www.sat.gob.mx/cfd/3", required = true)
    ...
    public static class Complemento {
        ...
        @XmlAnyElement(lax = true)
        protected TimbreFiscalDigital timbre;
